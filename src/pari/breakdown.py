...
`pari.eventgate` decides whether that happened. This shows *how*.
...
from pari.metrics import DEFAULT_BINNING, Binning, BrierDecomposition, brier
from pari.types import Outcome, QuestionRecord
